...
Particular.property("Air Density").setValue(0);
...
Particular.property("tc Particular-0703").setValue(6);
...
Particular.property("Life (seconds)").expression = "PlayerPos = thisComp.layer(\"" + Player.name + "\").transform.position;\n" +
